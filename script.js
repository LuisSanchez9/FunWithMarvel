...
// let ironman = ` The title of the movie is ${movieIronMan["title"]}`
// console.log(ironman)
// $("#display-area").append(ironman)
//
// let date = `${movieIronMan["releaseDate"]}`
// console.log(date)
// $("#display-area").append(date)
...
for (let i = 0; i < movieListDetailed.length;i++){
  ...
  let newElement = `<p> ${movieObject["title"]}  </p>`
  let newElements = `<p> ${movieObject["description"]} </p>`

  $("#display-area").append(newElement)
  $("#display-area").append(newElements)
 ...
 // let movieTitle = `${movieListDetailed[i]}`
